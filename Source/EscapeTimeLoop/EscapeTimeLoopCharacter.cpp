...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AEscapeTimeLoopCharacter::Move);
...
void AEscapeTimeLoopCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEscapeTimeLoopCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
